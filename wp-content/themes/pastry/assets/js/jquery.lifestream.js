          ...
          if ( item.html ) {
            $('<li class="'+ settings.classname + '-' +
               item.config.service + '">').append( item.html )
                                          .append("<div class='date-social " + item.config.service + "'><span class=\"ago-social\">" + jQuery.timeago(item.date) + "</span><span class=\"on-social\"><a href="+ item.url + ">" + item.config.service.capitalize() + "</a></span></div")                                     
                                          .appendTo( ul );
          }
        }
